...
function bones_wpsearch( $form ) {
  ...
  <label class="screen-reader-text" for="s" style="display:none">' . __('Search for:', 'bonestheme') . '</label>
  <input type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="Search the HXL blog..." />
